...
class TestFallback(unittest.TestCase):
    ...
    def test_fallback(self):
        pattern_file = open('test/test2_patterns.yml', 'r', encoding='utf-8')
        ...
        lang_file = open('test/test2.lang', 'r', encoding='utf-8')
        lang = mclang_to_dict(lang_file)
        test_ans_file = open('test/test2_ans.lang', 'r', encoding='utf-8')
        test_ans = mclang_to_dict(test_ans_file)

        glossary_file = open('test/test2_glossary.yml', 'r', encoding='utf-8')
